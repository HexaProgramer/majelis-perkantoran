...
{/* Grid nama klien */}
  ...
  <div className="absolute inset-0 pointer-events-none overflow-hidden">
    ...
    <svg className="absolute inset-0 w-full h-full opacity-5" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="flex flex-col gap-4">
              <div className="bg-blue-800 rounded-xl p-4 flex items-center gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-yellow-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              <a
              href="mailto:hanimafoundation@gmail.com" 
              className="hover:text-yellow-400 transition"
              >
                hanimafoundation@gmail.com
              </a>
              </div>
              <div className="bg-blue-800 rounded-xl p-4 flex items-center gap-4">
                <span className="text-yellow-400 text-2xl">📞</span>
                <a
                href="tel:+6281298662017"
                className="hover:text-yellow-400 transition"
                >
                  +62 812-9866-2017
                </a>
      ...
      <motion.a
        href="https://wa.me/6281298662017"
        target="_blank"
